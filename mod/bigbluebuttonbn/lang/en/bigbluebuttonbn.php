...
$string['activityoverview'] = 'You have upcoming OneScreen Revel sessions';
...
$string['bigbluebuttonbn:addinstance'] = 'Add a new OneScreen Revel room/activity';
$string['bigbluebuttonbn:join'] = 'Join a OneScreen Revel meeting';
$string['bigbluebuttonbn:view'] = 'View a room/activity';
$string['bigbluebuttonbn:managerecordings'] = 'Manage OneScreen Revel recordings';
...
$string['bigbluebuttonbn'] = 'OneScreen Revel';
$string['indicator:cognitivedepth'] = 'OneScreen Revel cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a OneScreen Revel activity.';
$string['indicator:socialbreadth'] = 'OneScreen Revel social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a OneScreen Revel activity.';
$string['modulename'] = 'OneScreen Revel';
$string['modulenameplural'] = 'OneScreen Revel';
$string['modulename_help'] = 'OneScreen Revel lets you create from within Moodle links to real-time on-line classrooms using OneScreen Revel, an open source web conferencing system for distance education.

Using OneScreen Revel you can specify for the title, description, calendar entry (which gives a date range for joining the session), groups, and details about the recording of the on-line session.';
$string['modulename_link'] = 'OneScreen Revel/view';
$string['pluginadministration'] = 'OneScreen Revel administration';
$string['pluginname'] = 'OneScreen Revel';
...
$string['search:activity'] = 'OneScreen Revel - activity information';
$string['search:tags'] = 'OneScreen Revel - tags information';

$string['privacy:metadata:bigbluebuttonbn'] = 'Stores the configuration for the room or activity that defines the features and general behaviour of the OneScreen Revel session.';
...
$string['privacy:metadata:bigbluebutton'] = 'In order to create and join OneScreen Revel sessions, user data needs to be exchanged with the server.';
$string['privacy:metadata:bigbluebutton:userid'] = 'The userid of the user accessing the OneScreen Revel server.';
$string['privacy:metadata:bigbluebutton:fullname'] = 'The fullname of the user accessing the OneScreen Revel server.';
...
$string['config_server_url'] = 'OneScreen Revel Server URL';
$string['config_server_url_description'] = 'The URL of your OneScreen Revel server must end with /bigbluebutton/. (This default URL is for a OneScreen Revel server provided by Blindside Networks that you can use for testing.)';
$string['config_shared_secret'] = 'OneScreen Revel Shared Secret';
$string['config_shared_secret_description'] = 'The security salt of your OneScreen Revel server.  (This default salt is for a OneScreen Revel server provided by Blindside Networks that you can use for testing.)';
...
$string['config_recording_default_description'] = 'If enabled the sessions created in OneScreen Revel will have recording capabilities.';
...
$string['config_waitformoderator_cache_ttl_description'] = 'To support a heavy load of clients this plugin makes use of a cache. This parameter defines the time the cache will be kept before the next request is sent to the OneScreen Revel server.';
...
$string['config_preuploadpresentation_description'] = 'These settings enable or disable options in the UI and also define default values for these options. The feature works only if the Moodle server is accessible to OneScreen Revel..';
...
$string['config_extended_capabilities_description'] = 'Configuration for extended capabilities when the OneScreen Revel server offers them.';
$string['config_uidelegation_enabled'] = 'UI delegation is enabled';
$string['config_uidelegation_enabled_description'] = 'These settings enable or disable the UI delegation to the OneScreen Revel server.';
$string['config_recordingready_enabled'] = 'Send notifications when a recording is ready';
$string['config_recordingready_enabled_description'] = 'Enable the plugin for sending notifications when the recording is ready. (It will only work if the script post_publish_recording_ready_callback is enabled in the OneScreen Revel server)';
$string['config_meetingevents_enabled'] = 'Register live events';
$string['config_meetingevents_enabled_description'] = 'Enable the plugin for accepting and processing live events after the session ends. (It must be enabled for "Activity completion" and will only work if the OneScreen Revel server is capable of processing post_events scripts)';
...
$string['config_warning_bigbluebuttonbn_cfg_deprecated'] = 'OneScreen Revel is making use of config.php with a global variable that has been deprecated. Please convert the file as it will not be supported in future versions';
...
$string['config_welcome_default_description'] = 'Replaces the default message set up for the OneScreen Revel server. The message can includes keywords  (%%CONFNAME%%, %%DIALNUM%%, %%CONFNUM%%) which will be substituted automatically, and also html tags like <b>...</b> or <i></i> ';
...
$string['general_error_unable_connect'] = 'Unable to connect. Please check the url of the OneScreen Revel server AND check to see if the OneScreen Revel server is running.';
...
$string['index_error_unable_display'] = 'Unable to display the meetings. Please check the url of the OneScreen Revel server AND check to see if the OneScreen Revel server is running.';
...
$string['index_heading'] = 'OneScreen Revel Rooms';
...
$string['mod_form_field_welcome_help'] = 'Replaces the default message setted up for the OneScreen Revel server. The message can includes keywords  (%%CONFNAME%%, %%DIALNUM%%, %%CONFNUM%%) which will be substituted automatically, and also html tags like &lt;b>...&lt;/b>, &lt;br />, &lt;u>&lt;/u> or &lt;i>&lt;/i> ';
$string['mod_form_field_welcome_default'] = '<br>Welcome to <b>%%CONFNAME%%</b>!<br><br>For help on using OneScreen Revel see these (short)  <a href="event:https://www.youtube.com/channel/UCjbyF9jBh7Bt83AQ12sKW_w"><u>tutorial videos</u></a>.<br><br>To join the audio bridge click the phone icon (top center). <b>Please use a headset to avoid causing background noise for others.</b>';
...
$string['mod_form_field_instanceprofiles_help'] = 'Select the type for this OneScreen Revel instance.';
...
$string['view_error_unable_join_student'] = 'Unable to connect to the OneScreen Revel server. Please contact your Teacher or the Administrator.';
$string['view_error_unable_join_teacher'] = 'Unable to connect to the OneScreen Revel server. Please contact the Administrator.';
$string['view_error_unable_join'] = 'Unable to join the meeting. Please check the url of the OneScreen Revel server AND check to see if the OneScreen Revel server is running.';
$string['view_error_bigbluebutton'] = 'OneScreen Revel responded with errors. {$a}';
$string['view_error_create'] = 'The OneScreen Revel server responded with an error message, the meeting could not be created.';
...
$string['view_noguests'] = 'The OneScreen Revel is not open to guests';
...
$string['view_message_recordings_disabled'] = 'Recordings were disabled on this server. OneScreen Revel instances for recordings only can not be used.';
...
$string['view_recording_publish_link_deleted'] = 'This link can not be re-published because the actual recording does not exist in the current OneScreen Revel server. The link should be removed.';
...
$string['view_recording_unprotect_link_deleted'] = 'This link can not be un-protected because the actual recording does not exist in the current OneScreen Revel server. The link should be removed.';
...
$string['view_error_current_state_not_found'] = 'Current state was not found. The recording may have been deleted or the OneScreen Revel server is not compatible with the action performed.';
$string['view_error_action_not_completed'] = 'Action could not be completed';
$string['view_warning_default_server'] = 'This Moodle server is making use of the OneScreen Revel testing server that comes pre-configured by default. It should be replaced for production.';
...
$string['index_error_noinstances'] = 'There are no instances of OneScreen Revel';
$string['index_error_bbtn'] = 'OneScreen Revel ID {$a} is incorrect';
